...
export const metadata: Metadata = {
  ...
  description: `Secure remote access setup for businesses. Professional installation of, 
    TeamViewer, ScreenConnect, and more. Enable your team to work efficiently from anywhere.`,
};
